...
const { registerUser, loginUser, getUserProfile,updateUserProfile, getDoctorById, bookDoctor,checkBookingStatus, getUserAppointments, cancelAppointment, cancelledAppointment, getAIResponse } = require('../controllers/userController');
