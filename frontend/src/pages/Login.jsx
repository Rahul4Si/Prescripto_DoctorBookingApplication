...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${BASE_URL}/api/user/loginUser`, { email, password });
  ...
  const handleCreateAccount = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${BASE_URL}/api/user/registerUser`, { name: fullName, email, password });
      if (response.data.success) {
        formData.email = '';
        formData.password = '';
        formData.fullName = '';
